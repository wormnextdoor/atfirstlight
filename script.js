function sendToPage(){
    var input = document.getElementById("search").value;
     //alert(input);
    if (input == "explain"){
        location.href = "rcf-lorelei.html";
        return false;
    }
    else if (input == "reemerge"){
        location.href = "rcf-2024.html";
        return false;
    }
        ...
        location.href = "ccf-02-2025.html";
        return false;
    }
    else if (input == "hiding"){
        location.href = "ccf-04-2025.html";
        return false;
    }
    else if (input == "1"){
        location.href = "ccf-2045.html"
        return false;
    }
    else if (input == "august 13"){
        location.href = "ccf-carmen.html";
        return false;
    }
    else if (input == "everything"){
        location.href = "ccf-lorelei.html";
        return false;
    }
    else if (input == "cold"){
        location.href = "ccf-oliver.html"
        return false;
    }
    else if (input == "2"){
        location.href = "ccf-jeremiah.html"
        return false;
    }
    else if (input == "mannequin"){
        location.href = "ccf-adelaide.html"
        return false;
    }
    else if (input == "3"){
        location.href = "ccf-elster-adels.html"
        return false;
    }
        else if (input == "28/09/2024"){
        location.href = "ccf-motelman.html"
        return false;
    }
    else if (input == "river"){
